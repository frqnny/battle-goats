...
public class EntitiesBG {
    ...
    public static final EntityModelLayer BATTLE_GOATS_LAYER = new EntityModelLayer(BATTLE_GOATS_LAYER_ID, "main");
    public static final EntityModelLayer BATTLE_GOATS_SADDLE_LAYER = new EntityModelLayer(BATTLE_GOATS_LAYER_ID, "saddle");
    ...
    public static void clientInit() {
        ...
        EntityModelLayerRegistry.registerModelLayer(BATTLE_GOATS_LAYER, () -> BattleGoatEntityModel.getTexturedModelData(Dilation.NONE));
        EntityModelLayerRegistry.registerModelLayer(BATTLE_GOATS_SADDLE_LAYER, () -> BattleGoatEntityModel.getTexturedModelData(new Dilation(0.5F)));
    }
}
